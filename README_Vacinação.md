...
# Perguntas de Pesquisa
   ...
   Qual a porcentagem de crianças imunizadas na idade correta, ao longo dos anos e regiões do Brasil? 
   
   Qual a correlação entre incidência das doenças e a vacinação?
   
   Como a pandemia pode ter afetado na porcentagem de imunização?
